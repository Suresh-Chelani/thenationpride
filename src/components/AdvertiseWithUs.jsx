    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          <div className="text-4xl font-bold text-[#4fe1aa] mb-2">10M+</div>
          <div className="text-gray-600">Monthly Page Views</div>
        </div>
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          <div className="text-4xl font-bold text-[#4fe1aa] mb-2">5M+</div>
          <div className="text-gray-600">Social Media Reach</div>
        </div>
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          <div className="text-4xl font-bold text-[#4fe1aa] mb-2">2M+</div>
          <div className="text-gray-600">Newsletter Subscribers</div>
        </div>
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          <div className="text-4xl font-bold text-[#4fe1aa] mb-2">500+</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="bg-white p-8 rounded-lg shadow-md">
          <div className="flex items-center mb-6">
            <Globe className="h-8 w-8 text-[#4fe1aa] mr-4" />
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <div className="flex items-center mb-6">
            <Users className="h-8 w-8 text-[#4fe1aa] mr-4" />
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <div className="flex items-center mb-6">
            <BarChart className="h-8 w-8 text-[#4fe1aa] mr-4" />
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <div className="flex items-center mb-6">
            <Zap className="h-8 w-8 text-[#4fe1aa] mr-4" />
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="text-[#4fe1aa] text-3xl font-bold mb-4">
              ₹50,000
            </div>
            <ul className="space-y-3 mb-8">
              <li className="flex items-center">
                <CheckCircle2 className="h-5 w-5 text-[#4fe1aa] mr-2" />
            ...
            <button className="w-full bg-[#215944] text-white py-2 rounded-md hover:bg-[#4fe1aa] transition-colors">
              Get Started
            </button>
          </div>
          <div className="bg-white rounded-lg shadow-md p-8 border-2 border-[#4fe1ba] relative">
            <div className="absolute top-0 right-0 bg-[#215944] text-white px-4 py-1 rounded-bl-lg">
              Popular
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="text-[#4fe1aa] text-3xl font-bold mb-4">Custom</div>
            <ul className="space-y-3 mb-8">
              <li className="flex items-center">
                <CheckCircle2 className="h-5 w-5 text-[#4fe1aa] mr-2" />
      ...
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="text-center">
            <Mail className="h-8 w-8 text-[#4fe1aa] mx-auto mb-4" />
            <h3 className="text-xl font-semibold mb-2">Email Us</h3>
            <p className="text-gray-600">ads@thenationpride.com</p>
          </div>
          <div className="text-center">
            <Phone className="h-8 w-8 text-[#4fe1aa] mx-auto mb-4" />
            <h3 className="text-xl font-semibold mb-2">Call Us</h3>
            <p className="text-gray-600">+91 (800) 123-4567</p>
          </div>
          <div className="text-center">
            <Calendar className="h-8 w-8 text-[#4fe1aa] mx-auto mb-4" />
        ...
        <div className="text-center">
          <Link
            to={"/contact"}
            className="inline-flex items-center bg-[#215944] text-white px-8 py-4 rounded-md text-lg font-semibold hover:bg-[#E67E22] transition-colors"
          >
